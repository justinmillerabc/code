...
SO_MAP = { 
           ...
           'sales_order_detail_next_date_of_service': 'SalesOrderDetailNextDateOfService',
           'sales_order_detail_next_billing_date': 'SalesOrderDetailNextBillingDate',
...
def insert_data_socitems(rec):
    ...
    sql = """INSERT INTO `soc_items` (
                                               ...
                                               `sales_order_detail_next_date_of_service`,
                                               `sales_order_detail_next_billing_date`,
    ...
    """ % (
                              ...
                              get_col_val(rec, 'sales_order_detail_next_date_of_service'),
                              get_col_val(rec, 'sales_order_detail_next_billing_date'),
